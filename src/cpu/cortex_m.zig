...
pub fn Cortex_M(Memory: type) type {
    return struct {
        const Self = @This();
        ...
        pub fn init(memory: Memory) !Self {
            var cortex_m: Self = .{ .memory = memory };
            try cortex_m.reinit();
            return cortex_m;
        }

        pub fn deinit(cortex_m: *Self) void {
        ...
        pub fn reinit(cortex_m: *Self) !void {
        ...
        pub fn halt(cortex_m: *Self) !void {
            try regs.armv6m.DHCSR_0_15.write(&cortex_m.memory, .{
                .C_DEBUGEN = 1,
                .C_MASKINTS = 0,
                .C_HALT = 1,
        ...
        pub fn set_catch_reset(cortex_m: *Self, enable: bool) !void {
            try regs.armv6m.DEMCR.modify(&cortex_m.memory, .{
                .VC_CORERESET = @intFromBool(enable),
            });
        }

        pub fn set_catch_fault(cortex_m: *Self, enable: bool) !void {
            try regs.armv6m.DEMCR.modify(&cortex_m.memory, .{
        ...
        pub fn reset(cortex_m: *Self) !void {
        ...
        /// Call only if the core is halted.
        pub fn read_cpu_register(cortex_m: *Self, reg: CPU_Register) !u32 {
        ...
        /// Call only if the core is halted.
        pub fn write_cpu_register(cortex_m: *Self, reg: CPU_Register, value: u32) !void {
